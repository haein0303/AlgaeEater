...
enum SESSION_ANIM_STATE { AN_IDLE, AN_WALK, AN_DEAD, AN_SKILL, AN_ATTACK_1, AN_ATTACK_2, AN_ATTACK_3, AN_ATTACK_4 };
...
public:
	...
	void send_cube_add(int c_id, float x, float y, float z, float degree, int color);
