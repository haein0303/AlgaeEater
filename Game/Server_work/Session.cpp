...
void SESSION::send_cube_add(int c_id, float x, float y, float z, float degree, int color, int hp)
{
...
void SESSION::send_field_add(int c_id, float x, float r, float z, int char_state, int fd_type)
{
