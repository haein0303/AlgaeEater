...
void PSO::CreateInputLayoutAndGSAndPSO(shared_ptr<Device> devicePtr, shared_ptr<RootSignature> rootSignaturePtr, shared_ptr<DSV> dsvPtr)
{
	...
	//셰이더 컴파일
	D3DCompileFromFile(L"../Performance_of_GeometryShader_in_Particles/GS.hlsl", nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, "VS_Main", "vs_5_0", 0, 0, &_vsBlob, &_errBlob);
	_gsPipelineDesc.VS = { _vsBlob->GetBufferPointer(), _vsBlob->GetBufferSize() };

	D3DCompileFromFile(L"../Performance_of_GeometryShader_in_Particles/GS.hlsl", nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, "PS_Main", "ps_5_0", 0, 0, &_psBlob, &_errBlob);
	_gsPipelineDesc.PS = { _psBlob->GetBufferPointer(), _psBlob->GetBufferSize() };

	D3DCompileFromFile(L"../Performance_of_GeometryShader_in_Particles/GS.hlsl", nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE, "GS_Main", "gs_5_0", 0, 0, &_gsBlob, &_errBlob);
